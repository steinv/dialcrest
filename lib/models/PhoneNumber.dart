class PhoneNumber {
  ...
  PhoneNumber.fromString(String phoneNumber)
    : countryCode = seperatePhoneAndDialCode(phoneNumber)[0],
      number = seperatePhoneAndDialCode(phoneNumber)[1]!;

  String getPhoneWithDialCode(PhoneNumber dialer) {
    return (countryCode != null) ? (countryCode! + number) : (dialer.countryCode != null) ? (dialer.countryCode! + number) : number;
  }
  ...
  static List<String?> seperatePhoneAndDialCode(String phoneNumber) {
    ...
    if (phoneWithDialCode.startsWith("0")) {
      phoneWithDialCode = phoneWithDialCode.substring(1);
    }
    if (!phoneWithDialCode.startsWith("+")) {
      return [null, phoneWithDialCode];
    }
